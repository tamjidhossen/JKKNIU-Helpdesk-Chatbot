...
> **Note on Performance:** Some advanced features (reranking, multi-query) are CPU-intensive. Enabling them may increase response latency but significantly improves accuracy. See `config.py` for performance tuning.
